...
class AttentionLayerWithStates(Module):
    """Implement the attention layer. Namely project the inputs to multi-head
    queries, keys and values, call the attention implementation and then
    reproject the output.
    ...
    def __init__(self, attention, d_model, n_heads, d_keys=None,
                 d_values=None, event_dispatcher=""):
        super(AttentionLayerWithStates, self).__init__()
    ...
    def forward(self, queries, keys, values, attn_mask, query_lengths,
        ...
        # Compute the attention
        new_values, state = self.inner_attention(
            queries,
            keys,
            values,
            attn_mask,
        ...
        # Project the output and return
        return self.out_projection(new_values), state
...
class EmptyAttentionLayerWithStates(Module):
    """
    Returns values
    ...
    def __init__(self, attention, d_model, n_heads, d_keys=None,
                 d_values=None, event_dispatcher=""):
        super(EmptyAttentionLayerWithStates, self).__init__()
